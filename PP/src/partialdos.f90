...
!
!-----------------------------------------------------------------------
SUBROUTINE  partialdos (Emin, Emax, DeltaE, kresolveddos, filpdos,skipfiles)
  !-----------------------------------------------------------------------
  !
  ...
  LOGICAL :: kresolveddos, skipfiles
  !
...
!
!-----------------------------------------------------------------------
SUBROUTINE  partialdos_nc (Emin, Emax, DeltaE, kresolveddos, filpdos,skipfiles)
  !-----------------------------------------------------------------------
  !
  USE io_global,  ONLY : stdout
