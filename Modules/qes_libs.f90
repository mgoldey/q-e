...
SUBROUTINE qes_write_epcdft_params(iun, obj)
   ...
   DO iconstraint = 1, obj%nconstr_epcdft
      !
      CALL iotk_write_begin(iun,trim('constraint'))
      !
      CALL iotk_write_begin( iun, 'index')
      write(iun,*) iconstraint
      CALL iotk_write_end( iun, 'index')
      CALL iotk_write_begin( iun, 'type')
      write(iun,*) trim(obj%epcdft_type(iconstraint))
      CALL iotk_write_end( iun, 'type')
      CALL iotk_write_begin( iun, 'A1')
      write(iun,*) obj%epcdft_locs(1,iconstraint)
      CALL iotk_write_end( iun, 'A1')
      CALL iotk_write_begin( iun, 'A2')
      write(iun,*) obj%epcdft_locs(2,iconstraint)
      CALL iotk_write_end( iun, 'A2')
      CALL iotk_write_begin( iun, 'D1')
      write(iun,*) obj%epcdft_locs(3,iconstraint)
      CALL iotk_write_end( iun, 'D1')
      CALL iotk_write_begin( iun, 'D2')
      write(iun,*) obj%epcdft_locs(4,iconstraint)
      CALL iotk_write_end( iun, 'D2')
      CALL iotk_write_begin( iun, 'target')
      write(iun,*) obj%epcdft_target(iconstraint)
      CALL iotk_write_end( iun, 'target')
      CALL iotk_write_begin( iun, 'strength')
      write(iun,*) obj%epcdft_strengths(iconstraint)
      CALL iotk_write_end( iun, 'strength')
      !
      CALL iotk_write_end(iun,trim('constraint'))
      !
   ENDDO
